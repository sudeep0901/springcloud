package com.sudeep.secureservice;
...
public class SpringClouldSecureSecureServiceApplication {

	@Autowired
	private OAuth2ClientContext clientContext;

	public static void main(String[] args) {
		SpringApplication.run(SpringClouldSecureSecureServiceApplication.class, args);
	}
